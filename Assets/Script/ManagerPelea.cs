	...
	void Start ()
	{
		...
		dragoncitoE2 = -1;
			...
			if (Random.Range (0, 10) == 0) {
				if (dragoncitoE1 != -1) {
					...
					dragoncitoE2 = DRAGONCITO_LODO+DESFASAJE_ENEMIGOS;
				}
			}
		...
		if (Controlador.escenaPrevia == "MATEO") {
			...
			if (Random.Range (0, 10) == 0) {
				if (dragoncitoE1 != -1) {
					// Segundo Dragoncito Normal
					dragoncitoE2 = DRAGONCITO_LAVA+DESFASAJE_ENEMIGOS;
				}
			}
		...
		if (Controlador.escenaPrevia == "DIEGO") {
			...
			if (Random.Range (0, 10) == 0) {
				if (dragoncitoE1 != -1) {
					...
					dragoncitoE2 = DRAGONCITO_ELECTRICO+DESFASAJE_ENEMIGOS;
				}
			}
		}
		if (Controlador.escenaPrevia == "ARIEL") {
			...
			if (Random.Range (0, 10) == 0) {
				if (dragoncitoE1 != -1) {
					...
					dragoncitoE2 = DRAGONCITO_METAL+DESFASAJE_ENEMIGOS;
				}
			}
		}
		if (Controlador.escenaPrevia == "MAXIMILIANO") {
			...
			if (Random.Range (0, 10) == 0) {
				if (dragoncitoE1 != -1) {
					...
					dragoncitoE2 = DRAGONCITO_HIELO+DESFASAJE_ENEMIGOS;
				}
			}
			...
			if (!peleadores[enemigoActual].sigueVivo) { 
				...
				if(dragoncitoE1>-1){
					...
					if(Controlador.escenaPrevia == "ISRAEL"){
						...
						if(Controlador.escenaPrevia == "SANTI"){
							Controlador.GanarHijo(DRAGONCITO_NORMAL);
						}
						if(Controlador.escenaPrevia == "ARIEL"){
							Controlador.GanarHijo(DRAGONCITO_FUEGO);
						}
						if(Controlador.escenaPrevia == "MATEO"){
							Controlador.GanarHijo(DRAGONCITO_NORMAL);
						}
						if(Controlador.escenaPrevia == "DIEGO"){
							Controlador.GanarHijo(DRAGONCITO_TIERRA);
						}
						if(Controlador.escenaPrevia == "MAXIMILIANO"){
							Controlador.GanarHijo(DRAGONCITO_AIRE);
						}
						if (Controlador.escenaPrevia == "ISRAEL") {
							Controlador.GanarHijo (DRAGONCITO_AGUA);
					}
